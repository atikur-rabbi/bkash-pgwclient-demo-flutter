...
You must have to use patched version of [webview_flutter](https://pub.dev/packages/webview_flutter) (discuss details bellow), or can use [flutter_inappwebview](https://pub.dev/packages/flutter_inappwebview)
